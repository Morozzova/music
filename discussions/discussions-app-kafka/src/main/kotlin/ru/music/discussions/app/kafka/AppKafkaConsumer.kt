...
interface ConsumerStrategy {
    ...
    fun serialize(source: DiscContext): String
    fun deserialize(value: String, target: DiscContext)
}

class AppKafkaConsumer(
    private val config: AppKafkaConfig,
    consumerStrategies: List<ConsumerStrategy>,
    private val processor: DiscussionsProcessor = DiscussionsProcessor(),
    ...
    private fun sendResponse(context: DiscContext, strategy: ConsumerStrategy, outputTopic: String) {
